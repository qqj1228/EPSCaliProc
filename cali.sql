...
(
    ...
    RoutineStatus VARCHAR(2) NULL, -- 例程状态
    RoutineResult VARCHAR(2) NULL, -- 例程结果
...
EXEC sp_addextendedproperty N'MS_Description', N'标定总结果', N'USER', N'dbo', N'TABLE', N'EPSCaliProc', N'COLUMN', N'Result'
EXEC sp_addextendedproperty N'MS_Description', N'例程状态', N'USER', N'dbo', N'TABLE', N'EPSCaliProc', N'COLUMN', N'RoutineStatus'
EXEC sp_addextendedproperty N'MS_Description', N'例程结果', N'USER', N'dbo', N'TABLE', N'EPSCaliProc', N'COLUMN', N'RoutineResult'
...
INSERT JAC.dbo.EPSCaliProc
    VALUES ('testvincode012345', '2018-06-07', '10:41:08', 'X', '01', '81', '511F00,01')
GO
-- 测试: 修改数据
